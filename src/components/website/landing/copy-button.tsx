...
export function HomeCopyButton() {
  ...
  return (
    <button
      ...
      <div
        className={cn(
          'absolute bottom-full left-1/2 mb-2 -translate-x-1/2 transform rounded border border-border bg-muted px-2 py-1 text-xs text-primary-foreground text-white shadow-lg transition-all duration-200',
